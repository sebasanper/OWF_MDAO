        ...
        for m in a:
            ...
            if [n, m] in line2 or [m, n] in line2:
                ...
                if [n, m] in line2:
                    ...
                    counter[n][1] = distance(coord[n], coord[m])
                    # print counter
                if [m, n] in line2:
                    line2.remove([m, n])
                    counter[m][0] += counter[n][0]
...
if __name__ == '__main__':
    ...
    for i in range(len(max_counter)):
        i += 1
        losses.append(max_counter[i - 1] * i ** 2.0)

    print losses
    print sum(losses)

# TODO: run with one type of cable and compare. Losses with 2 types: 14286.434823
# TODO: make function, input is cable topology, output is losses (efficiency).
