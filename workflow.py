    ...
    def connect(self, turbine_coordinates):
        ...
        for i in range(len(self.wind_directions)):
            ...
            if self.wake_turbulence_model != "ConstantTurbulence":
                self.turbulences = max_turbulence_one_angle(turbine_coordinates, self.wind_speeds[i], self.windrose.direction[i], self.freestream_turbulence, Jensen, self.thrust_coefficient_model, self.thrust_lookup_file, self.wake_turbulence_model)
            if self.cable_topology_model != "ConstantCable":
...
if __name__ == '__main__':
    ...
    test_study(25, "layout_creator/random_layout4.dat", "random4_25bins.dat")
